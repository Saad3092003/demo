...
import { AllCategories_sm, allProjects } from "../../handleSlice";
import Category from "../../components/Category";

function Category_sm({ loadScreen }) {
    // const cats = [
    //     {
    //         img: electricalimg,
    //         catname: 'Electrical',
    ...
    const name ='SM';
    let Category_smDetails = useSelector(
    ...
    return (
        <>
            <div className='account-bg p-5'>
                <h1 className='text-white text-center' data-aos='zoom-in'>Showcase Management</h1>
            </div>

            <Category loadScreen={loadScreen} categoryDetails={category} pageSize={8} productDetails={Category_smDetails} pageName={name} />
        </>
    );
}

export default Category_sm;