...
import { LoggedMember, addbooking_hsm, addbooking_showcase, getCart } from '../../handleSlice';
import { useDispatch } from 'react-redux';
import { url3 } from '../../components/port';

function ShowCaseCheckOut({ setalertStatus, setalertmode, setalertText, loadScreen }) {
    ...
    let [cartItems, setCartItems] = useState([CheckData.SData]);
    ...
    const handleSubmit = async () => {
        ...
        formData.append("title", CheckData.SData.project_name);
        ...
        formData.append("price", CheckData.SData.project_rate);
    ...
    const handleHitPayGateway = async () => {
        if (loadspin !== true) {
            setloadspin(true);
            let apiDetails = {
                amount: CheckData.SData.project_rate,
                currency: "SGD",
                email: memData.email,
                phone: memData.phn,
                name: memData.uname,
                payment_methods: ["paynow_online"],
                purpose: CheckData.SData.project_name,
                                    ...
                                    <div key={index} className='bg-white border-bottom border-2 fadeIn px-4 py-3'>
                                        <div className='row g-3'>
                                            <div className='col-md-3 p-0'>
                                                <img className='img-fluid w-100 object-fit-cover' style={{ maxHeight: '150px' }} src={item.thumbnail_photo} alt={item.pname} />
                                            </div>
                                            <div className='col-md-9'>
                                                ...
                                                <div className=' ms-3 '>
                                                    ...
                                                    <h3 className='mt-1'>S$ {item.project_rate}</h3>
                                                    <p className='mt-1'>{item.project_sub_desc}</p>
                            ...
                            <div className="bg-white shadow" data-aos='fade-up'>
                                ...
                                <div className='p-4 border-bottom border-2 '>
                                    <div className="d-flex justify-content-between">
                                        ...
                                        <div className='fw-bold'>S$ {CheckData.SData.project_rate}</div>
                                    </div>
                                ...
                                <div className='p-4'>
                                    <div className='d-flex justify-content-between'>
                                        <h5>Total Amount</h5>
                                        <h5>${CheckData.SData.project_rate}</h5>
